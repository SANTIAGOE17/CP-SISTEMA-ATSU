...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_coprogreso'])) {
            $_SESSION['scriptcase']['dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_coprogreso'];
        }
    }
}
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'coprogreso', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'coprogreso', 1, $this->force_db_utf8);
    }
    else {
...
class dashboard_control {
    ...
    function init()
    {
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['Reporte_metricas2'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['Reporte_metricas1'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['Reporte_metricas3'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['Reporte_metricas4'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
<div class='grid-stack'>
                ...
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="4" data-gs-width="6" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-5">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-5">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle">Cantidad de cobros realizados por Usuario</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-5"><iframe id="id-iframe-5" name="dbifrm_widget6" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('Reporte_metricas1'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget6"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget6&compact_mode=1&remove_margin=0&remove_border=0" alt="1000"></iframe></div>
                    </div>
                </div>
                ...
                <div  class="grid-stack-item" data-gs-x="8" data-gs-y="4" data-gs-width="4" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-7">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-7">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle">Estados de cobros</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-7"><iframe id="id-iframe-7" name="dbifrm_widget8" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('Reporte_metricas4'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget8"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget8&compact_mode=1&remove_margin=0&remove_border=0" alt="1000"></iframe></div>
                    </div>
                </div></div>
...
<script type="text/javascript">
 $( document ).ready(function() {
    setTimeout(function() { refreshWidgetIndex('widget2', '1', 500000); }, 500000);
    setTimeout(function() { refreshWidgetIndex('widget3', '2', 500000); }, 500000);
    setTimeout(function() { refreshWidgetIndex('widget4', '3', 500000); }, 500000);
    setTimeout(function() { refreshWidgetIndex('widget5', '4', 500000); }, 500000);
 });
...
<?php
    ...
    function getIndexContentData_widget2() {
        ...
        {
            $sSql = "SELECT COUNT(clave), YEAR(fecha) & '-' & FORMAT(MONTH(fecha), '00') FROM solicitud GROUP BY YEAR(fecha) & '-' & FORMAT(MONTH(fecha), '00') ORDER BY YEAR(fecha) & '-' & FORMAT(MONTH(fecha), '00') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"clave\"), CONCAT(EXTRACT(YEAR FROM \"fecha\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"fecha\"), 'FM00')) FROM solicitud GROUP BY 2 ORDER BY CONCAT(EXTRACT(YEAR FROM \"fecha\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"fecha\"), 'FM00')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`clave`), CONCAT(YEAR(`fecha`), '-', LPAD(MONTH(`fecha`), 2, '0')) FROM solicitud GROUP BY 2 ORDER BY CONCAT(YEAR(`fecha`), '-', LPAD(MONTH(`fecha`), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`clave`), strftime('%Y', `fecha`) || '-' || strftime('%m', `fecha`) FROM solicitud GROUP BY 2 ORDER BY strftime('%Y', `fecha`) || '-' || strftime('%m', `fecha`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT COUNT(\"clave\"), EXTRACT(YEAR FROM \"fecha\") || '-' || LPAD(EXTRACT(MONTH FROM \"fecha\"), 2, '0') FROM solicitud GROUP BY 2 ORDER BY EXTRACT(YEAR FROM \"fecha\") || '-' || LPAD(EXTRACT(MONTH FROM \"fecha\"), 2, '0') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
        {
            $sSql = "SELECT COUNT(clave), CAST(YEAR(fecha) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(fecha) AS VARCHAR(2)), 2) FROM solicitud GROUP BY CAST(YEAR(fecha) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(fecha) AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(fecha) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(fecha) AS VARCHAR(2)), 2) DESC";
        }
        else 
        {
            $sSql = "SELECT COUNT(clave), YYYYMM(fecha) FROM solicitud GROUP BY 2 ORDER BY YYYYMM(fecha) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget2">Cantidad de solicitudes por mes</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget3() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(clave) FROM solicitud";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"clave\") FROM solicitud";
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget3">Cantidad total de solicitudes</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget4() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(valor), YEAR(fecha) & '-' & FORMAT(MONTH(fecha), '00') FROM solicitud GROUP BY YEAR(fecha) & '-' & FORMAT(MONTH(fecha), '00') ORDER BY YEAR(fecha) & '-' & FORMAT(MONTH(fecha), '00') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT SUM(\"valor\"), CONCAT(EXTRACT(YEAR FROM \"fecha\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"fecha\"), 'FM00')) FROM solicitud GROUP BY 2 ORDER BY CONCAT(EXTRACT(YEAR FROM \"fecha\"), '-', TO_CHAR(EXTRACT(MONTH FROM \"fecha\"), 'FM00')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT SUM(`valor`), CONCAT(YEAR(`fecha`), '-', LPAD(MONTH(`fecha`), 2, '0')) FROM solicitud GROUP BY 2 ORDER BY CONCAT(YEAR(`fecha`), '-', LPAD(MONTH(`fecha`), 2, '0')) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT SUM(`valor`), strftime('%Y', `fecha`) || '-' || strftime('%m', `fecha`) FROM solicitud GROUP BY 2 ORDER BY strftime('%Y', `fecha`) || '-' || strftime('%m', `fecha`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT SUM(\"valor\"), EXTRACT(YEAR FROM \"fecha\") || '-' || LPAD(EXTRACT(MONTH FROM \"fecha\"), 2, '0') FROM solicitud GROUP BY 2 ORDER BY EXTRACT(YEAR FROM \"fecha\") || '-' || LPAD(EXTRACT(MONTH FROM \"fecha\"), 2, '0') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
        {
            $sSql = "SELECT SUM(valor), CAST(YEAR(fecha) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(fecha) AS VARCHAR(2)), 2) FROM solicitud GROUP BY CAST(YEAR(fecha) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(fecha) AS VARCHAR(2)), 2) ORDER BY CAST(YEAR(fecha) AS VARCHAR(4)) + '-' + RIGHT('0' + CAST(MONTH(fecha) AS VARCHAR(2)), 2) DESC";
        }
        else 
        {
            $sSql = "SELECT SUM(valor), YYYYMM(fecha) FROM solicitud GROUP BY 2 ORDER BY YYYYMM(fecha) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget4">Total montos por mes</span></div>
        ...
        <div class="clearfix"><span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget4"><span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget4">{$this->indexData['difference_formatted']}</span> {$this->indexData['icon']}</span></div>
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget5">Diferencia porcentual de solictudes por mes</span></div>
