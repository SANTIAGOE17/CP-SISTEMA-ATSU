<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_reporte']['sc_process_barr'] = true;
require_once('../pdfreport_reporte/index.php');
unset($_SESSION['scriptcase']['pdfreport_reporte']['sc_process_barr']);
$ExportCtrl = new pdfreport_reporte_export_control;
$ExportCtrl->Export_barr();

class pdfreport_reporte_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> reporte</TITLE>
