...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "clave";$Nm_numeric[] = "valor";$Nm_numeric[] = "tiempo";$Nm_numeric[] = "aprovacion1";$Nm_numeric[] = "aprovacion2";$Nm_numeric[] = "tipo";$Nm_numeric[] = "status";$Nm_numeric[] = "clave";$Nm_numeric[] = "valor";$Nm_numeric[] = "tiempo";$Nm_numeric[] = "aprovacion1";$Nm_numeric[] = "aprovacion2";$Nm_numeric[] = "tipo";$Nm_numeric[] = "status";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_clave_cond" name="clave_cond" onChange="nm_campos_between(document.getElementById('id_vis_clave'), this, 'clave')">
      ...
      <br><span id="id_hide_clave"  <?php echo $str_hide_clave?>><INPUT  type="text" id="SC_clave" name="clave" value="<?php echo NM_encode_input($clave) ?>" size=50 alt="{datatype: 'integer', maxLength: 255, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tiempo_cond" name="tiempo_cond" onChange="nm_campos_between(document.getElementById('id_vis_tiempo'), this, 'tiempo')">
      ...
      <br><span id="id_hide_tiempo"  <?php echo $str_hide_tiempo?>><INPUT  type="text" id="SC_tiempo" name="tiempo" value="<?php echo NM_encode_input($tiempo) ?>" size=50 alt="{datatype: 'integer', maxLength: 255, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
