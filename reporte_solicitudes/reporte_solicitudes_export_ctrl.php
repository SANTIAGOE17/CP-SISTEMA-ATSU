<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_solicitudes']['sc_process_barr'] = true;
require_once('../reporte_solicitudes/index.php');
unset($_SESSION['scriptcase']['reporte_solicitudes']['sc_process_barr']);
$ExportCtrl = new reporte_solicitudes_export_control;
$ExportCtrl->Export_barr();

class reporte_solicitudes_export_control
{
