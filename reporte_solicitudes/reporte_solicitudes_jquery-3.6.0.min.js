...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_reporte_solicitudes').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_reporte_solicitudes').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_reporte_solicitudes').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_reporte_solicitudes').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_reporte_solicitudes').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_reporte_solicitudes').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_reporte_solicitudes').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_reporte_solicitudes').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_reporte_solicitudes').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_reporte_solicitudes').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_reporte_solicitudes').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_reporte_solicitudes').style.width  = '0px';
        if (oResp["setValue"]) {
