...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["coprogreso_____reporte_solicitudes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["coprogreso_____reporte_solicitudes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_solicitudes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reporte_solicitudes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_solicitudes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reporte_solicitudes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reporte_solicitudes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>reporte_solicitudes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reporte_solicitudes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reporte_solicitudes']['embutida_filho'] as $ind => $sc_init)
          {
