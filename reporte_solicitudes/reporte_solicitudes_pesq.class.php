...
class reporte_solicitudes_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . reporte_solicitudes_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . reporte_solicitudes_pack_protect_string($Tipo_filter[0]) . "\">.." . reporte_solicitudes_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>reporte_solicitudes/reporte_solicitudes_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="reporte_solicitudes_ajax_search.js"></script>
 <script type="text/javascript" src="reporte_solicitudes_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="reporte_solicitudes_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['reporte_solicitudes']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['reporte_solicitudes']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_tiempo_cond#NMF#' + search_get_sel_txt('SC_tiempo_cond') + '@NMF@';
  str_out += 'SC_tiempo#NMF#' + search_get_text('SC_tiempo') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Reporte de solicitudes</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $clave = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['clave']; 
          $clave_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['clave_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_ano']; 
          $fecha_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_hor']; 
          $fecha_min = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_min']; 
          $fecha_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_seg']; 
          $fecha_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_hor']; 
          $fecha_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_min']; 
          $fecha_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_seg']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_cond']; 
          $valor = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['valor']; 
          $valor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['valor_cond']; 
          $tiempo = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['tiempo']; 
          $tiempo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['tiempo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['NM_operador']; 
      ...
      { 
          ...
          if (strtoupper($tiempo_cond) != "II" && strtoupper($tiempo_cond) != "QP" && strtoupper($tiempo_cond) != "NP" && strtoupper($tiempo_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($tiempo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($tiempo_cond) || empty($tiempo_cond))
      {
         $tiempo_cond = "gt";
      }
      ...
      $str_hide_tiempo = (in_array($tiempo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_clave = ('bw' == $clave_cond) ? $display_aberto : $display_fechado;
      ...
      $str_display_tiempo = ('bw' == $tiempo_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($tiempo) || $tiempo == "")
      {
          $tiempo = "";
      }
      if (isset($tiempo) && !empty($tiempo))
      {
         $tmp_pos = strpos($tiempo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tiempo = substr($tiempo, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_clave_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['clave'])) ? $this->New_label['clave'] : "Clave"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_clave_cond" name="clave_cond" onChange="nm_campos_between(document.getElementById('id_vis_clave'), this, 'clave')">
       <OPTION value="gt" <?php if ("gt" == $clave_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $clave_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
...
?>
<INPUT  type="text" id="SC_clave" name="clave" value="<?php echo NM_encode_input($clave) ?>" size=50 alt="{datatype: 'integer', maxLength: 255, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<INPUT  type="text" id="SC_valor" name="valor" value="<?php echo NM_encode_input($valor) ?>" size=50 alt="{datatype: 'decimal', maxLength: 255, precision: 2, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_tiempo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tiempo'])) ? $this->New_label['tiempo'] : "Tiempo en meses"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tiempo_cond" name="tiempo_cond" onChange="nm_campos_between(document.getElementById('id_vis_tiempo'), this, 'tiempo')">
       <OPTION value="gt" <?php if ("gt" == $tiempo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $tiempo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tiempo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tiempo" <?php echo $str_hide_tiempo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tiempo'])) ? $this->New_label['tiempo'] : "Tiempo en meses";
 $nmgp_tab_label .= "tiempo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_tiempo" name="tiempo" value="<?php echo NM_encode_input($tiempo) ?>" size=50 alt="{datatype: 'integer', maxLength: 255, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("reporte_solicitudes_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reporte_solicitudes']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['reporte_solicitudes']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.clave_cond.value = 'gt';
   ...
   document.F1.tiempo_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_tiempo'), document.F1.tiempo_cond, 'tiempo');
   document.F1.tiempo.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fecha_dia').bind('change', function() {sc_reporte_solicitudes_valida_dia(this)});
    $('#SC_fecha_hor').bind('change', function() {sc_reporte_solicitudes_valida_hora(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_reporte_solicitudes_valida_dia(this)});
    $('#SC_fecha_input_2_hor').bind('change', function() {sc_reporte_solicitudes_valida_hora(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_reporte_solicitudes_valida_mes(this)});
    $('#SC_fecha_input_2_min').bind('change', function() {sc_reporte_solicitudes_valida_min(this)});
    $('#SC_fecha_input_2_seg').bind('change', function() {sc_reporte_solicitudes_valida_seg(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_reporte_solicitudes_valida_mes(this)});
    $('#SC_fecha_min').bind('change', function() {sc_reporte_solicitudes_valida_min(this)});
    $('#SC_fecha_seg').bind('change', function() {sc_reporte_solicitudes_valida_seg(this)});
 }
 function sc_reporte_solicitudes_valida_dia(obj)
 {
 ...
 function sc_reporte_solicitudes_valida_mes(obj)
 {
 ...
 function sc_reporte_solicitudes_valida_hora(obj)
 {
 ...
 function sc_reporte_solicitudes_valida_min(obj)
 {
 ...
 function sc_reporte_solicitudes_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tiempo_cond'] = 'cond';
      $tp_fields['SC_tiempo'] = 'text';
   ...
   {
      global $clave_cond, $clave,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_hor, $fecha_min, $fecha_seg, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano, $fecha_input_2_min, $fecha_input_2_hor, $fecha_input_2_seg,
             $valor_cond, $valor,
             $tiempo_cond, $tiempo, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $tiempo_cond_salva = $tiempo_cond; 
      if (!isset($tiempo_input_2) || $tiempo_input_2 == "")
      {
          $tiempo_input_2 = $tiempo;
      }
      $this->nm_tira_mask($clave, "xxxxxx");
      if ($clave_cond != "in")
      {
          nm_limpa_numero($clave, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($valor_cond != "in")
      {
          if ($C_formatado)
      ...
      if ($tiempo_cond != "in")
      {
          nm_limpa_numero($tiempo, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['clave'] = $clave; 
      if (is_array($clave) && !empty($clave))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0] = $clave;
      }
      elseif ($clave_cond_salva == "nu" || $clave_cond_salva == "nn" || $clave_cond_salva == "ep" || $clave_cond_salva == "ne" || !empty($clave))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][0] = $clave;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['clave_cond'] = $clave_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['cmp'] = "clave"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['opc'] = $clave_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq']['clave'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_hor'] = $fecha_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_min'] = $fecha_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_seg'] = $fecha_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_hor'] = $fecha_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_min'] = $fecha_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2_seg'] = $fecha_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $fecha_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $fecha_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $fecha_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $fecha_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $fecha_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $fecha_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['cmp'] = "fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['opc'] = $fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq']['fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['valor'] = $valor; 
      if (is_array($valor) && !empty($valor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0] = $valor;
      }
      elseif ($valor_cond_salva == "nu" || $valor_cond_salva == "nn" || $valor_cond_salva == "ep" || $valor_cond_salva == "ne" || !empty($valor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][0] = $valor;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['valor_cond'] = $valor_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['cmp'] = "valor"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['opc'] = $valor_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq']['valor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['tiempo'] = $tiempo; 
      if (is_array($tiempo) && !empty($tiempo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0] = $tiempo;
      }
      elseif ($tiempo_cond_salva == "nu" || $tiempo_cond_salva == "nn" || $tiempo_cond_salva == "ep" || $tiempo_cond_salva == "ne" || !empty($tiempo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['val'][0][0] = $tiempo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['tiempo_cond'] = $tiempo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['cmp'] = "tiempo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid]['opc'] = $tiempo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq']['tiempo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'] = $Temp_Busca;
      }
      ...
      $this->cmp_formatado['clave'] = $Conteudo;
      $Conteudo = $valor;
      if (strtoupper($valor_cond) != "II" && strtoupper($valor_cond) != "QP" && strtoupper($valor_cond) != "NP" && strtoupper($valor_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['tiempo'] = $Conteudo;
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq']['fecha']['label'] = $nmgp_tab_label['fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq']['fecha']['descr'] = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['grid_pesq']['fecha']['hint']  = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      //----- $tiempo
      $this->Date_part = false;
      if (isset($tiempo) || $tiempo_cond == "nu" || $tiempo_cond == "nn" || $tiempo_cond == "ep" || $tiempo_cond == "ne")
      {
         $this->monta_condicao("tiempo", $tiempo_cond, $tiempo, "", "tiempo");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_solicitudes']['cond_pesq'] .= $this->NM_operador;
