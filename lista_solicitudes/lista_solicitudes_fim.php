...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["coprogreso_____lista_solicitudes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["coprogreso_____lista_solicitudes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_solicitud'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_solicitudes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['lista_solicitudes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_solicitudes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['lista_solicitudes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['lista_solicitudes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['lista_solicitudes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['lista_solicitudes']['embutida_filho'] as $ind => $sc_init)
          {
