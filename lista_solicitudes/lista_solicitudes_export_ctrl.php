<?php
@session_start() ;
$_SESSION['scriptcase']['lista_solicitudes']['sc_process_barr'] = true;
require_once('../lista_solicitudes/index.php');
unset($_SESSION['scriptcase']['lista_solicitudes']['sc_process_barr']);
$ExportCtrl = new lista_solicitudes_export_control;
$ExportCtrl->Export_barr();

class lista_solicitudes_export_control
{
