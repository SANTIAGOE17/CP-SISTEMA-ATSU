<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="clave" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['clave']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['verificaciones']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="verificaciones"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['verificaciones']['where_detal']))
  {
?>  
...
{
    document.getElementById('verificaciones_form0').style.width='1px';
    document.getElementById('verificaciones_form0').style.height='0px';
    document.getElementById('verificaciones_form0').style.display='none';
    document.getElementById('verificaciones_form0').style.overflow='scroll';
    document.getElementById('verificaciones_form1').style.width='1px';
    document.getElementById('verificaciones_form1').style.height='0px';
    document.getElementById('verificaciones_form1').style.display='none';
    document.getElementById('verificaciones_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['verificaciones']['pdf_view']) {
?>
...
?>
   ...
   if ("verificaciones_form1" == N_pagina) {
