...
?>
  ...
  // ---------- Validate apellido
  function do_ajax_app_form_add_users_validate_apellido()
  {
    var nomeCampo_apellido = "apellido";
    var var_apellido = scAjaxGetFieldText(nomeCampo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_apellido(var_apellido, var_script_case_init, do_ajax_app_form_add_users_validate_apellido_cb);
  } // do_ajax_app_form_add_users_validate_apellido

  function do_ajax_app_form_add_users_validate_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_apellido_cb
  ...
  // ---------- Validate ncedula
  function do_ajax_app_form_add_users_validate_ncedula()
  {
    var nomeCampo_ncedula = "ncedula";
    var var_ncedula = scAjaxGetFieldText(nomeCampo_ncedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_ncedula(var_ncedula, var_script_case_init, do_ajax_app_form_add_users_validate_ncedula_cb);
  } // do_ajax_app_form_add_users_validate_ncedula

  function do_ajax_app_form_add_users_validate_ncedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ncedula";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_ncedula_cb

  // ---------- Validate ncuenta
  function do_ajax_app_form_add_users_validate_ncuenta()
  {
    var nomeCampo_ncuenta = "ncuenta";
    var var_ncuenta = scAjaxGetFieldText(nomeCampo_ncuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_ncuenta(var_ncuenta, var_script_case_init, do_ajax_app_form_add_users_validate_ncuenta_cb);
  } // do_ajax_app_form_add_users_validate_ncuenta

  function do_ajax_app_form_add_users_validate_ncuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ncuenta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_ncuenta_cb

  // ---------- Validate telefono1
  function do_ajax_app_form_add_users_validate_telefono1()
  {
    var nomeCampo_telefono1 = "telefono1";
    var var_telefono1 = scAjaxGetFieldText(nomeCampo_telefono1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_telefono1(var_telefono1, var_script_case_init, do_ajax_app_form_add_users_validate_telefono1_cb);
  } // do_ajax_app_form_add_users_validate_telefono1

  function do_ajax_app_form_add_users_validate_telefono1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telefono1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_telefono1_cb

  // ---------- Validate genero
  function do_ajax_app_form_add_users_validate_genero()
  {
    var nomeCampo_genero = "genero";
    var var_genero = scAjaxGetFieldRadio(nomeCampo_genero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_genero(var_genero, var_script_case_init, do_ajax_app_form_add_users_validate_genero_cb);
  } // do_ajax_app_form_add_users_validate_genero

  function do_ajax_app_form_add_users_validate_genero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "genero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_genero_cb

  // ---------- Validate departamento
  function do_ajax_app_form_add_users_validate_departamento()
  {
    var nomeCampo_departamento = "departamento";
    var var_departamento = scAjaxGetFieldSelect(nomeCampo_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_departamento(var_departamento, var_script_case_init, do_ajax_app_form_add_users_validate_departamento_cb);
  } // do_ajax_app_form_add_users_validate_departamento

  function do_ajax_app_form_add_users_validate_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_departamento_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_form_add_users_submit_form()
  {
    ...
    var var_ncedula = scAjaxGetFieldText("ncedula");
    var var_ncuenta = scAjaxGetFieldText("ncuenta");
    var var_telefono1 = scAjaxGetFieldText("telefono1");
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_apellido, var_email, var_ncedula, var_ncuenta, var_telefono1, var_genero, var_departamento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_submit_form_cb);
  ...
  function do_ajax_app_form_add_users_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("ncedula");
      scAjaxHideErrorDisplay("ncuenta");
      scAjaxHideErrorDisplay("telefono1");
...
?>
  ...
  function perform_ajax_app_form_add_users_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_add_users_navigate_form_cb);
...
?>
  ...
  ajax_field_list[4] = "apellido";
  ajax_field_list[5] = "email";
  ajax_field_list[6] = "ncedula";
  ajax_field_list[7] = "ncuenta";
  ajax_field_list[8] = "telefono1";
  ajax_field_list[9] = "genero";
  ajax_field_list[10] = "departamento";
  ...
  var ajax_error_list = {
    ...
    "name": {"label": "Nombres", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "apellido": {"label": "Apellidos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "ncedula": {"label": "N° de Cédula", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ncuenta": {"label": "N° de Cuenta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telefono1": {"label": "Teléfono ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["ncedula"][1] = "ncedula";
  ajax_field_mult["ncuenta"][1] = "ncuenta";
  ajax_field_mult["telefono1"][1] = "telefono1";
  ...
  var ajax_field_id = {
    ...
    "ncedula": new Array("hidden_field_label_ncedula", "hidden_field_data_ncedula"),
    "ncuenta": new Array("hidden_field_label_ncuenta", "hidden_field_data_ncuenta"),
    "telefono1": new Array("hidden_field_label_telefono1", "hidden_field_data_telefono1"),
