...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_estado_solicitud').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_estado_solicitud').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_estado_solicitud').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_estado_solicitud').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_estado_solicitud').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_estado_solicitud').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_estado_solicitud').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_estado_solicitud').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_estado_solicitud').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_estado_solicitud').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_estado_solicitud').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_estado_solicitud').style.width  = '0px';
        if (oResp["setValue"]) {
