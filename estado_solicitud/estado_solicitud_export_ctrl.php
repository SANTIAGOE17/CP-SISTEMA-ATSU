<?php
@session_start() ;
$_SESSION['scriptcase']['estado_solicitud']['sc_process_barr'] = true;
require_once('../estado_solicitud/index.php');
unset($_SESSION['scriptcase']['estado_solicitud']['sc_process_barr']);
$ExportCtrl = new estado_solicitud_export_control;
$ExportCtrl->Export_barr();

class estado_solicitud_export_control
{
