...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["coprogreso_____estado_solicitud"]))
   {
      unset($_SESSION['session_sec_aplicacao']["coprogreso_____estado_solicitud"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['estado_solicitud']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['estado_solicitud']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['estado_solicitud']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['estado_solicitud']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['estado_solicitud']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['estado_solicitud']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['estado_solicitud']['embutida_filho'] as $ind => $sc_init)
          {
