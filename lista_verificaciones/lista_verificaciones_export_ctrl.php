<?php
@session_start() ;
$_SESSION['scriptcase']['lista_verificaciones']['sc_process_barr'] = true;
require_once('../lista_verificaciones/index.php');
unset($_SESSION['scriptcase']['lista_verificaciones']['sc_process_barr']);
$ExportCtrl = new lista_verificaciones_export_control;
$ExportCtrl->Export_barr();

class lista_verificaciones_export_control
{
