<?php
   include_once('lista_verificaciones_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class lista_verificaciones_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "lista_verificaciones"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_hr_criacao   = "115024"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20220222"; 
      $this->nm_hr_ult_alt   = "003549"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['lista_verificaciones']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['lista_verificaciones']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['lista_verificaciones']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/lista_verificaciones';
      ...
      $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['lista_verificaciones']['actual_lang']) || $_SESSION['scriptcase']['lista_verificaciones']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['lista_verificaciones']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("lista_verificaciones_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "verificaciones";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/verificaciones_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/verificaciones_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/verificaciones_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/verificaciones_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["verificaciones"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = 'modal';
      $this->sc_lig_target["A_@scinf__@scinf_verificaciones"] = 'modal';
      if ($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["lista_verificaciones"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["lista_verificaciones"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $this->link_verificaciones =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('verificaciones') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "lista_verificaciones_erro.class.php"); 
      $this->Erro = new lista_verificaciones_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('lista_verificaciones'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['lista_verificaciones']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao']) && $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_perfil']) && $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['lista_verificaciones']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['lista_verificaciones']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_conexao'], $this->root . $this->path_prod, 'coprogreso', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['lista_verificaciones']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class lista_verificaciones_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['lista_verificaciones']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['lista_verificaciones'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class lista_verificaciones_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['lista_verificaciones']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['lista_verificaciones'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_lista_verificaciones($cadapar[1]);
                       nm_protect_num_lista_verificaciones($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_ibase'])) 
      { 
          $this->Ini = new lista_verificaciones_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['lista_verificaciones']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['lista_verificaciones'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['lista_verificaciones']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['lista_verificaciones']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('lista_verificaciones') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['lista_verificaciones']['label'] = "Lista de Solicitudes para verificar";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "lista_verificaciones_erro.class.php"); 
      } 
      $this->Erro      = new lista_verificaciones_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "lista_verificaciones_lookup.class.php"); 
      } 
      $this->Lookup       = new lista_verificaciones_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_lista_verificaciones_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "lista_verificaciones_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "lista_verificaciones_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_lista_verificaciones_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_lista_verificaciones_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'][] = "clave";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'][] = "persona";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'][] = "valor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'][] = "tiempo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'][] = "fecha";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'][] = "aprovacion1";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'][] = "aprovacion2";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['usr_cmp_sel']['aprovacion2'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['lista_verificaciones']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['lista_verificaciones']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['lista_verificaciones']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['lista_verificaciones']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['lista_verificaciones']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq'];
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq'] = 'grid';
          } 
      } 
      $this->Ini->grid_search_change_fil = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new lista_verificaciones_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_fast']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['contr_total_geral'] = "NAO";
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_lista_verificaciones_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_lista_verificaciones.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_lista_verificaciones_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_lista_verificaciones_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_lista_verificaciones_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_xls.class.php"); 
          } 
          $this->xls  = new lista_verificaciones_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_res_xls.class.php"); 
          } 
          $this->xls  = new lista_verificaciones_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_xml.class.php"); 
          } 
          $this->xml  = new lista_verificaciones_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_res_xml.class.php"); 
          } 
          $this->xml  = new lista_verificaciones_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_json.class.php"); 
          } 
          $this->json  = new lista_verificaciones_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_res_json.class.php"); 
          } 
          $this->json  = new lista_verificaciones_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_csv.class.php"); 
          } 
          $this->csv  = new lista_verificaciones_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_res_csv.class.php"); 
          } 
          $this->csv  = new lista_verificaciones_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_rtf.class.php"); 
          } 
          $this->rtf  = new lista_verificaciones_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_res_rtf.class.php"); 
          } 
          $this->rtf  = new lista_verificaciones_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . lista_verificaciones . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
          ...
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_pesq.class.php"); 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new lista_verificaciones_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_lista_verificaciones_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "lista_verificaciones/lista_verificaciones_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "lista_verificaciones_grid.class.php"); 
          } 
          $this->grid  = new lista_verificaciones_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    lista_verificaciones_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        lista_verificaciones_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        lista_verificaciones_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "lista_verificaciones.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_filtro'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['fast_search']);
          return;
      }
      $comando = "";
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "aprovacion2", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_persona($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "persona", $arg_search, $data_lookup);
              }
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_orig']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "clave";$nm_numeric[] = "valor";$nm_numeric[] = "tiempo";$nm_numeric[] = "aprovacion1";$nm_numeric[] = "aprovacion2";$nm_numeric[] = "tipo";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
   ...
   {
       $data_look = array();
       $data_look['1'] = "Aprobada";
       $data_look['0'] = "Rechazada";
       $result = array();
   ...
   function SC_lookup_persona($condicao, $campo)
   {
       $result     = array();
       $campo_orig = $campo;
       $campo      = substr($this->Db->qstr($campo), 1, -1);
      ...
      { 
          $nm_comando = "SELECT login + ' : ' + name + '  ' + apellido, login FROM sec_users WHERE (login + ' : ' + name + '  ' + apellido LIKE '%$campo%')" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT concat(login,' : ', name, '  ',apellido), login FROM sec_users WHERE (concat(login,' : ', name, '  ',apellido) LIKE '%$campo%')" ; 
      } 
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['grid_pesq']);
               continue;
           }
           ...
           if (!isset($busca[$dats[0]]))
           {
               ...
               if ($dats[0] == "valor")
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
                   nm_limpa_valor($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'][$dats[0]], $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
                       nm_limpa_valor($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'][$dats[0] . '_input_2'], $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
                   }
               }
               elseif ($dats[0] == "fecha")
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'][$dats[0] . '_' . $tp] = $vl;
                   }
                   if (!empty($val1))
                   {
                       foreach ($val1 as $tp => $vl)
                       {
                          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'][$dats[0] . '_input_2_' . $tp] = $vl;
                       }
                   }
               }
               else
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "lista_verificaciones_pesq.class.php"); 
   ...
   function proc_del_grid_search($cmp_del, $del_all)
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_ano"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2_ano"] = "";
      }
      elseif (in_array($cmp_del, array('fecha')))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_hor"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_min"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_seg"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2_hor"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2_min"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2_seg"] = "";
      }
      elseif (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Lista de Solicitudes para verificar :: Doc</TITLE>
...
<form name="Fdown" method="get" action="lista_verificaciones_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="lista_verificaciones"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['lista_verificaciones'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['lista_verificaciones']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_lista_verificaciones($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_lista_verificaciones($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['lista_verificaciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "lista_verificaciones") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_coprogreso'])) {
               $_SESSION['scriptcase']['lista_verificaciones']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_coprogreso'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['lista_verificaciones']['master_pai']) && $_SESSION['sc_session'][$init_filho]['lista_verificaciones']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['lista_verificaciones']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']);
               $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida']) && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['lista_verificaciones']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['lista_verificaciones']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['lista_verificaciones']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['lista_verificaciones']['protect_modal']) && !empty($_SESSION['scriptcase']['lista_verificaciones']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['lista_verificaciones']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "lista_verificaciones";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'lista_verificaciones' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/lista_verificaciones/'))
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['contr_total_geral'] = "NAO";
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'lista_verificaciones')
   {
       $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/lista_verificaciones_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] = $nmgp_opcao ;  
       }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['volta_redirect_tp'] = "";
           $nm_url_saida = "lista_verificaciones_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_modal'] = true;
               }
               $nm_url_saida = "lista_verificaciones_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['mostra_edit'] = "N";   
           } 
       ...
       $contr_lista_verificaciones = new lista_verificaciones_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] = "busca";
          $contr_lista_verificaciones->NM_ajax_flag = true;
          $contr_lista_verificaciones->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] = "busca";
          $contr_lista_verificaciones->NM_ajax_flag = true;
          $contr_lista_verificaciones->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] = "busca";
          $contr_lista_verificaciones->NM_ajax_flag = true;
          $contr_lista_verificaciones->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opcao'] = "busca";
          $contr_lista_verificaciones->NM_ajax_flag = true;
          $contr_lista_verificaciones->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_lista_verificaciones->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_lista_verificaciones(&$str)
   {
   ...
   function nm_protect_num_lista_verificaciones($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function lista_verificaciones_pack_protect_string($sString)
   {
    ...
    function lista_verificaciones_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
