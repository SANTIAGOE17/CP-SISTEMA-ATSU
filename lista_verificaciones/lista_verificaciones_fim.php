...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["coprogreso_____lista_verificaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["coprogreso_____lista_verificaciones"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['verificaciones'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>lista_verificaciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['lista_verificaciones']['embutida_filho'] as $ind => $sc_init)
          {
