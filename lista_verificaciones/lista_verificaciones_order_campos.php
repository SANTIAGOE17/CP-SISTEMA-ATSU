...
<?php
   ...
   $Ord_Cmp = new lista_verificaciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class lista_verificaciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["clave"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["clave"])) ? $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["clave"] : "N° de solicitud ";
   $tab_ger_campos['persona'] = "on";
   $tab_def_campos['persona'] = "persona";
   $tab_labels["persona"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["persona"])) ? $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["persona"] : "Persona";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["valor"] : "Valor";
   $tab_ger_campos['tiempo'] = "on";
   $tab_def_campos['tiempo'] = "tiempo";
   $tab_labels["tiempo"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["tiempo"])) ? $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["tiempo"] : "Tiempo en meses ";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['aprovacion1'] = "on";
   $tab_def_campos['aprovacion1'] = "aprovacion1";
   $tab_labels["aprovacion1"]   = (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["aprovacion1"])) ? $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['labels']["aprovacion1"] : "Aprobación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "lista_verificaciones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['lista_verificaciones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
