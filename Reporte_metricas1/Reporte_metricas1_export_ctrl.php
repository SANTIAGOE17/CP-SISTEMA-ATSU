<?php
@session_start() ;
$_SESSION['scriptcase']['Reporte_metricas1']['sc_process_barr'] = true;
require_once('../Reporte_metricas1/index.php');
unset($_SESSION['scriptcase']['Reporte_metricas1']['sc_process_barr']);
$ExportCtrl = new Reporte_metricas1_export_control;
$ExportCtrl->Export_barr();

class Reporte_metricas1_export_control
{
