...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_hr_criacao   = "005106"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20220222"; 
      $this->nm_hr_ult_alt   = "013649"; 
...
<?php
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_departamento"] = '';
      ...
      $this->link_form_departamento =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_departamento') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_departamento']['glo_nm_conexao'], $this->root . $this->path_prod, 'coprogreso', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_departamento']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_departamento_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['embutida_ibase'] = true;
      }
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_departamento']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_departamento']['label'] = "Lista de  departamentos";
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['field_order'][] = "clave";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['field_order'][] = "descripcion";
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_departamento/grid_departamento_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_departamento_rtf.class.php"); 
          } 
          $this->rtf  = new grid_departamento_rtf();
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Lista de  departamentos :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_departamento']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_departamento']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_coprogreso'])) {
               $_SESSION['scriptcase']['grid_departamento']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_coprogreso'];
           }
       }
   }
   ...
   { 
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_departamento']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_departamento']['mostra_edit'] = "S";
       }
