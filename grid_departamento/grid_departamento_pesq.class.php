...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Lista de  departamentos</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $clave = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['clave']; 
          $clave_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['clave_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['descripcion_cond']; 
...
?>
<INPUT  type="text" id="SC_descripcion" name="descripcion" value="<?php echo NM_encode_input($descripcion) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descripcion" name="descripcion_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
   ...
   function trata_campos()
   {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['clave'] = $clave; 
      if (is_array($clave) && !empty($clave))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['val'][0] = $clave;
      }
      elseif ($clave_cond_salva == "nu" || $clave_cond_salva == "nn" || $clave_cond_salva == "ep" || $clave_cond_salva == "ne" || !empty($clave))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['val'][0][0] = $clave;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['clave_cond'] = $clave_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['cmp'] = "clave"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['opc'] = $clave_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['grid_pesq']['clave'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['descripcion'] = $descripcion; 
      if (is_array($descripcion) && !empty($descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['val'][0] = $descripcion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['val'][0][0] = $descripcion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['cmp'] = "descripcion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid]['opc'] = $descripcion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['grid_pesq']['descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
