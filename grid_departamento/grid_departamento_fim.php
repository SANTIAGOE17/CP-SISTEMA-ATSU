...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["coprogreso_____grid_departamento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["coprogreso_____grid_departamento"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_departamento'] = array();
   $fecha_janela = false;
