...
class grid_departamento_det
{
 ...
 function monta_det()
 {
   ...
   {
       $nmgp_select .= " where  clave = $parms_det[0]" ;  
   } 
   else 
   { 
       $nmgp_select .= " where  clave = $parms_det[0]" ;  
...
//--- 
   ...
   $nm_saida->saida("<HEAD>\r\n");
   $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_detl_title'] . " departamento</TITLE>\r\n");
...
$nm_saida->saida("</script>\r\n");
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->clave))); 
   $conteudo_original = $conteudo; 
          ...
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'clave', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'clave', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_clave_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_clave_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_departamento']['opcao'] == "pdf")
...
//--- 
   ...
   { 
       ...
       if ($this->nmgp_botoes['det_pdf'] == "on")
       {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_departamento/grid_departamento_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=es&conf_socor=N&sc_ver_93=" . s . "&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
