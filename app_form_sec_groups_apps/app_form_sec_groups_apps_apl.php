...
//---------- 
   ...
   { 
      ...
      else
      {
          ...
          if ($rs->EOF && !$this->proc_fast_search && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['empty_filter']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['empty_filter'])) 
          { 
              $this->nm_flag_saida_novo = "S"; 
              $this->nmgp_opcao = "novo"; 
              $this->sc_evento  = "novo"; 
