<?php
@session_start() ;
$_SESSION['scriptcase']['Reporte_metricas4']['sc_process_barr'] = true;
require_once('../Reporte_metricas4/index.php');
unset($_SESSION['scriptcase']['Reporte_metricas4']['sc_process_barr']);
$ExportCtrl = new Reporte_metricas4_export_control;
$ExportCtrl->Export_barr();

class Reporte_metricas4_export_control
{
