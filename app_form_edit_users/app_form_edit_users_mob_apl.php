...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_max_reg']) == "all")
      {
...
//---------------------------------------------------------
    ...
    function ValidateField_genero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->genero != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_genero']) && !in_array($this->genero, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_genero']))
          {
              $hasError = true;
    ...
    function ValidateField_departamento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->departamento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_departamento']) && !in_array($this->departamento, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_departamento']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('1') => str_replace('<', '&lt;',app_form_edit_users_mob_pack_protect_string("Masculino ")));
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('0') => str_replace('<', '&lt;',app_form_edit_users_mob_pack_protect_string("Femenino ")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_genero'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_genero'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['genero']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          ...
          $tempOptionId = "id-opt-departamento-" . $x;
          echo "      <input type=checkbox id=\"" . $tempOptionId . "\" class=\"sc-ui-checkbox-groups sc-ui-checkbox-departamento\" name=\"departamento[$ind]\" value=\"$cadacheck[1]\"" ; 
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['departamento']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "name = '$this->name', email = '$this->email', active = '$this->active', apellido = '$this->apellido', ncedula = '$this->ncedula', telefono1 = '$this->telefono1', genero = $this->genero, departamento = $this->departamento, ncuenta = '$this->ncuenta'"; 
              } 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'pswd', 'confirm_pswd', 'name', 'apellido', 'email', 'active', 'ncedula', 'ncuenta', 'telefono1', 'genero', 'groups', 'departamento'), $aDoNotUpdate);
              $this->ajax_return_values();
