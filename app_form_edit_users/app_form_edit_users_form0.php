...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_genero'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_genero'][] = '0'; ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['btn_label']['birpara'];
        }
?>
