...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["ncedula" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["ncuenta" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["telefono1" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["ncedula" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["ncedula" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["ncuenta" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["ncuenta" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["telefono1" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["telefono1" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_apellido' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_apellido_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_app_form_edit_users_apellido_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_app_form_edit_users_apellido_onfocus(this, iSeqRow) });
  $('#id_sc_field_ncedula' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_ncedula_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_app_form_edit_users_ncedula_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_app_form_edit_users_ncedula_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefono1' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_telefono1_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_app_form_edit_users_telefono1_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_app_form_edit_users_telefono1_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefono2' + iSeqRow).bind('change', function() { sc_app_form_edit_users_telefono2_onchange(this, iSeqRow) });
  $('#id_sc_field_genero' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_genero_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_app_form_edit_users_genero_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_app_form_edit_users_genero_onfocus(this, iSeqRow) });
  $('#id_sc_field_departamento' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_departamento_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_app_form_edit_users_departamento_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app_form_edit_users_departamento_onfocus(this, iSeqRow) });
  $('#id_sc_field_ncuenta' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_ncuenta_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_app_form_edit_users_ncuenta_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_app_form_edit_users_ncuenta_onfocus(this, iSeqRow) });
...
function sc_app_form_edit_users_apellido_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_apellido();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_apellido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_apellido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_ncedula_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_ncedula();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_ncedula_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_ncedula_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_telefono1_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_telefono1();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_telefono1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_telefono1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_telefono2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_genero_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_genero();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_genero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_genero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_departamento_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_departamento();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_departamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_departamento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_ncuenta_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_ncuenta();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_ncuenta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_ncuenta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("ncedula", "", status);
	displayChange_field("ncuenta", "", status);
	displayChange_field("telefono1", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_ncedula(row, status);
	displayChange_field_ncuenta(row, status);
	displayChange_field_telefono1(row, status);
...
function displayChange_field_ncedula(row, status) {
}

function displayChange_field_ncuenta(row, status) {
}

function displayChange_field_telefono1(row, status) {
}
