...
?>
  ...
  // ---------- Validate clave
  function do_ajax_form_departamento_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldHidden(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_validate_clave(var_clave, var_script_case_init, do_ajax_form_departamento_validate_clave_cb);
  } // do_ajax_form_departamento_validate_clave

  function do_ajax_form_departamento_validate_clave_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_validate_clave_cb

  // ---------- Validate descripcion
  function do_ajax_form_departamento_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_departamento_validate_descripcion_cb);
  } // do_ajax_form_departamento_validate_descripcion

  function do_ajax_form_departamento_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_validate_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_departamento_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_departamento_submit_form(var_clave, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_departamento_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_departamento_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_departamento_navigate_form(var_clave, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_departamento_navigate_form_cb);
