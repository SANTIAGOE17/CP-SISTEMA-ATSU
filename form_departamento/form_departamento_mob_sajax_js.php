  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_departamento_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_departamento_mob_form();
	}
...
?>
  ...
  // ---------- Validate clave
  function do_ajax_form_departamento_mob_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldHidden(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_mob_validate_clave(var_clave, var_script_case_init, do_ajax_form_departamento_mob_validate_clave_cb);
  } // do_ajax_form_departamento_mob_validate_clave

  function do_ajax_form_departamento_mob_validate_clave_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_mob_validate_clave_cb

  // ---------- Validate descripcion
  function do_ajax_form_departamento_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_departamento_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_departamento_mob_validate_descripcion_cb);
  } // do_ajax_form_departamento_mob_validate_descripcion

  function do_ajax_form_departamento_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_departamento_mob_validate_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_departamento_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_departamento_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_departamento_mob_submit_form(var_clave, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_departamento_mob_submit_form_cb);
  } // do_ajax_form_departamento_mob_submit_form

  function do_ajax_form_departamento_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_departamento_mob_submit_form_cb_after_alert);
  } // do_ajax_form_departamento_mob_submit_form_cb
  function do_ajax_form_departamento_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_departamento_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_departamento_mob_navigate_form()
  {
    perform_ajax_form_departamento_mob_navigate_form();
  }

  function perform_ajax_form_departamento_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_departamento_mob_navigate_form(var_clave, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_departamento_mob_navigate_form_cb);
  } // do_ajax_form_departamento_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_departamento_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_departamento_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_departamento_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_departamento_mob_navigate_form_cb
  function do_ajax_form_departamento_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_departamento_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_departamento_mob_navigate_form_cb_after_alert
  function sc_hide_form_departamento_mob_form()
  {
