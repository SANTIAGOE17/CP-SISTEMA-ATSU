<?php
@session_start() ;
$_SESSION['scriptcase']['grid_public_historial']['sc_process_barr'] = true;
require_once('../grid_public_historial/index.php');
unset($_SESSION['scriptcase']['grid_public_historial']['sc_process_barr']);
$ExportCtrl = new grid_public_historial_export_control;
$ExportCtrl->Export_barr();

class grid_public_historial_export_control
{
