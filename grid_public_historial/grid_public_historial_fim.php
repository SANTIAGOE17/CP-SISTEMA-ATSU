...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["coprogreso_____grid_public_historial"]))
   {
      unset($_SESSION['session_sec_aplicacao']["coprogreso_____grid_public_historial"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_historial']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_public_historial']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_historial']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_public_historial']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_public_historial']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_public_historial</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_public_historial']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_public_historial']['embutida_filho'] as $ind => $sc_init)
          {
