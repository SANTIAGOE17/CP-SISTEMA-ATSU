...
<?php
      ...
      $this->sc_lig_target["A_@scinf__@scinf_app_form_sec_apps"] = '_self';
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_apps']['glo_nm_conexao'], $this->root . $this->path_prod, 'coprogreso', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['field_order'];
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_coprogreso.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_coprogreso'])) {
               $_SESSION['scriptcase']['app_grid_sec_apps']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_coprogreso'];
           }
       }
   }
