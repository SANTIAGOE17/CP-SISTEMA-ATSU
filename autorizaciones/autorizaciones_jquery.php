...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'observacion':
      case 'status':
        sc_exib_ocult_pag('autorizaciones_form0');
        break;
      case 'historial':
        sc_exib_ocult_pag('autorizaciones_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_clave' + iSeqRow).bind('blur', function() { sc_autorizaciones_clave_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_autorizaciones_clave_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_autorizaciones_fecha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_autorizaciones_fecha_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_autorizaciones_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_hora' + iSeqRow).bind('blur', function() { sc_autorizaciones_fecha_hora_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_autorizaciones_fecha_hora_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_autorizaciones_fecha_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor' + iSeqRow).bind('blur', function() { sc_autorizaciones_valor_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_autorizaciones_valor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tiempo' + iSeqRow).bind('blur', function() { sc_autorizaciones_tiempo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_autorizaciones_tiempo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_aprovacion1' + iSeqRow).bind('blur', function() { sc_autorizaciones_aprovacion1_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_autorizaciones_aprovacion1_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_autorizaciones_aprovacion1_onfocus(this, iSeqRow) });
  $('#id_sc_field_aprovacion2' + iSeqRow).bind('change', function() { sc_autorizaciones_aprovacion2_onchange(this, iSeqRow) });
  $('#id_sc_field_persona' + iSeqRow).bind('blur', function() { sc_autorizaciones_persona_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_autorizaciones_persona_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_autorizaciones_tipo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_autorizaciones_tipo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_status' + iSeqRow).bind('blur', function() { sc_autorizaciones_status_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_autorizaciones_status_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_historial' + iSeqRow).bind('blur', function() { sc_autorizaciones_historial_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_autorizaciones_historial_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_observacion' + iSeqRow).bind('blur', function() { sc_autorizaciones_observacion_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_autorizaciones_observacion_onchange(this, iSeqRow) })
...
function sc_autorizaciones_clave_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_fecha_hora_onblur(oThis, iSeqRow) {
  do_ajax_autorizaciones_validate_fecha();
  scCssBlur(oThis);
}

function sc_autorizaciones_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_autorizaciones_fecha_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_fecha_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_autorizaciones_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_tiempo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_aprovacion1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_aprovacion2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_persona_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_historial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_autorizaciones_observacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_autorizaciones_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_autorizaciones_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'autorizaciones')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
