  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_autorizaciones" == sTestField)
        {
...
?>
  ...
  // ---------- Validate clave
  function do_ajax_autorizaciones_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldHidden(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_clave(var_clave, var_script_case_init, do_ajax_autorizaciones_validate_clave_cb);
  } // do_ajax_autorizaciones_validate_clave

  function do_ajax_autorizaciones_validate_clave_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_clave_cb

  // ---------- Validate persona
  function do_ajax_autorizaciones_validate_persona()
  {
    var nomeCampo_persona = "persona";
    var var_persona = scAjaxGetFieldSelect(nomeCampo_persona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_persona(var_persona, var_script_case_init, do_ajax_autorizaciones_validate_persona_cb);
  } // do_ajax_autorizaciones_validate_persona

  function do_ajax_autorizaciones_validate_persona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "persona";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_persona_cb

  // ---------- Validate fecha
  function do_ajax_autorizaciones_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_fecha(var_fecha, var_script_case_init, do_ajax_autorizaciones_validate_fecha_cb);
  } // do_ajax_autorizaciones_validate_fecha

  function do_ajax_autorizaciones_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_fecha_cb

  // ---------- Validate tipo
  function do_ajax_autorizaciones_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_tipo(var_tipo, var_script_case_init, do_ajax_autorizaciones_validate_tipo_cb);
  } // do_ajax_autorizaciones_validate_tipo

  function do_ajax_autorizaciones_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_tipo_cb

  // ---------- Validate valor
  function do_ajax_autorizaciones_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldHidden(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_valor(var_valor, var_script_case_init, do_ajax_autorizaciones_validate_valor_cb);
  } // do_ajax_autorizaciones_validate_valor

  function do_ajax_autorizaciones_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_valor_cb

  // ---------- Validate tiempo
  function do_ajax_autorizaciones_validate_tiempo()
  {
    var nomeCampo_tiempo = "tiempo";
    var var_tiempo = scAjaxGetFieldHidden(nomeCampo_tiempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_tiempo(var_tiempo, var_script_case_init, do_ajax_autorizaciones_validate_tiempo_cb);
  } // do_ajax_autorizaciones_validate_tiempo

  function do_ajax_autorizaciones_validate_tiempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiempo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_tiempo_cb

  // ---------- Validate aprovacion1
  function do_ajax_autorizaciones_validate_aprovacion1()
  {
    var nomeCampo_aprovacion1 = "aprovacion1";
    var var_aprovacion1 = scAjaxGetFieldRadio(nomeCampo_aprovacion1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_aprovacion1(var_aprovacion1, var_script_case_init, do_ajax_autorizaciones_validate_aprovacion1_cb);
  } // do_ajax_autorizaciones_validate_aprovacion1

  function do_ajax_autorizaciones_validate_aprovacion1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aprovacion1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_aprovacion1_cb

  // ---------- Validate observacion
  function do_ajax_autorizaciones_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_observacion(var_observacion, var_script_case_init, do_ajax_autorizaciones_validate_observacion_cb);
  } // do_ajax_autorizaciones_validate_observacion

  function do_ajax_autorizaciones_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_observacion_cb

  // ---------- Validate status
  function do_ajax_autorizaciones_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldCheckbox(nomeCampo_status, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_status(var_status, var_script_case_init, do_ajax_autorizaciones_validate_status_cb);
  } // do_ajax_autorizaciones_validate_status

  function do_ajax_autorizaciones_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_status_cb

  // ---------- Validate historial
  function do_ajax_autorizaciones_validate_historial()
  {
    var nomeCampo_historial = "historial";
    var var_historial = scAjaxGetFieldText(nomeCampo_historial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_validate_historial(var_historial, var_script_case_init, do_ajax_autorizaciones_validate_historial_cb);
  } // do_ajax_autorizaciones_validate_historial

  function do_ajax_autorizaciones_validate_historial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "historial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_validate_historial_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_autorizaciones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_autorizaciones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_clave = scAjaxGetFieldHidden("clave");
    var var_persona = scAjaxGetFieldSelect("persona");
    var var_fecha = scAjaxGetFieldHidden("fecha");
    var var_tipo = scAjaxGetFieldRadio("tipo");
    var var_valor = scAjaxGetFieldHidden("valor");
    var var_tiempo = scAjaxGetFieldHidden("tiempo");
    var var_aprovacion1 = scAjaxGetFieldRadio("aprovacion1");
    ...
    scAjaxProcOn();
    x_ajax_autorizaciones_submit_form(var_clave, var_persona, var_fecha, var_tipo, var_valor, var_tiempo, var_aprovacion1, var_observacion, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_autorizaciones_submit_form_cb);
  } // do_ajax_autorizaciones_submit_form

  function do_ajax_autorizaciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("aprovacion1");
      scAjaxHideErrorDisplay("observacion");
      scAjaxHideErrorDisplay("status");
      scAjaxHideErrorDisplay("historial");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_autorizaciones_submit_form_cb_after_alert);
  } // do_ajax_autorizaciones_submit_form_cb
  function do_ajax_autorizaciones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_autorizaciones_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_public_historial"] = "off";

  function do_ajax_autorizaciones_navigate_form()
  {
    perform_ajax_autorizaciones_navigate_form();
  }

  function perform_ajax_autorizaciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_public_historial"] = "on";
    x_ajax_autorizaciones_navigate_form(var_clave, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_autorizaciones_navigate_form_cb);
  } // do_ajax_autorizaciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['autorizaciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_autorizaciones_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_public_historial"] && "nmsc_iframe_liga_grid_public_historial" != scMasterDetailIframe["nmsc_iframe_liga_grid_public_historial"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_public_historial"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_public_historial').contentWindow.nm_move('apl_detalhe', true, '600');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_autorizaciones_navigate_form_cb_after_alert);
  } // do_ajax_autorizaciones_navigate_form_cb
  function do_ajax_autorizaciones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_autorizaciones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_autorizaciones_navigate_form_cb_after_alert
  function sc_hide_autorizaciones_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_public_historial"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[5] = "tiempo";
  ajax_field_list[6] = "aprovacion1";
  ajax_field_list[7] = "observacion";
  ajax_field_list[8] = "status";
  ajax_field_list[9] = "historial";
  ...
  var ajax_error_list = {
    ...
    "persona": {"label": "Persona", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "aprovacion1": {"label": "Aprobación ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "status": {"label": "Aprobar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "historial": {"label": "Historial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["aprovacion1"][1] = "aprovacion1";
  ajax_field_mult["observacion"][1] = "observacion";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["historial"][1] = "historial";
  ...
  var ajax_field_id = {
    ...
    "aprovacion1": new Array("hidden_field_label_aprovacion1", "hidden_field_data_aprovacion1"),
    ...
    "historial": new Array("hidden_field_label_historial", "hidden_field_data_historial")
  };
