  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_autorizaciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_autorizaciones_mob_form();
	}
...
?>
  ...
  // ---------- Validate clave
  function do_ajax_autorizaciones_mob_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldHidden(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_clave(var_clave, var_script_case_init, do_ajax_autorizaciones_mob_validate_clave_cb);
  } // do_ajax_autorizaciones_mob_validate_clave

  function do_ajax_autorizaciones_mob_validate_clave_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_clave_cb

  // ---------- Validate persona
  function do_ajax_autorizaciones_mob_validate_persona()
  {
    var nomeCampo_persona = "persona";
    var var_persona = scAjaxGetFieldSelect(nomeCampo_persona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_persona(var_persona, var_script_case_init, do_ajax_autorizaciones_mob_validate_persona_cb);
  } // do_ajax_autorizaciones_mob_validate_persona

  function do_ajax_autorizaciones_mob_validate_persona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "persona";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_persona_cb

  // ---------- Validate fecha
  function do_ajax_autorizaciones_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_autorizaciones_mob_validate_fecha_cb);
  } // do_ajax_autorizaciones_mob_validate_fecha

  function do_ajax_autorizaciones_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_fecha_cb

  // ---------- Validate tipo
  function do_ajax_autorizaciones_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_autorizaciones_mob_validate_tipo_cb);
  } // do_ajax_autorizaciones_mob_validate_tipo

  function do_ajax_autorizaciones_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_tipo_cb

  // ---------- Validate valor
  function do_ajax_autorizaciones_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldHidden(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_valor(var_valor, var_script_case_init, do_ajax_autorizaciones_mob_validate_valor_cb);
  } // do_ajax_autorizaciones_mob_validate_valor

  function do_ajax_autorizaciones_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_valor_cb

  // ---------- Validate tiempo
  function do_ajax_autorizaciones_mob_validate_tiempo()
  {
    var nomeCampo_tiempo = "tiempo";
    var var_tiempo = scAjaxGetFieldHidden(nomeCampo_tiempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_tiempo(var_tiempo, var_script_case_init, do_ajax_autorizaciones_mob_validate_tiempo_cb);
  } // do_ajax_autorizaciones_mob_validate_tiempo

  function do_ajax_autorizaciones_mob_validate_tiempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiempo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_tiempo_cb

  // ---------- Validate aprovacion1
  function do_ajax_autorizaciones_mob_validate_aprovacion1()
  {
    var nomeCampo_aprovacion1 = "aprovacion1";
    var var_aprovacion1 = scAjaxGetFieldRadio(nomeCampo_aprovacion1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_aprovacion1(var_aprovacion1, var_script_case_init, do_ajax_autorizaciones_mob_validate_aprovacion1_cb);
  } // do_ajax_autorizaciones_mob_validate_aprovacion1

  function do_ajax_autorizaciones_mob_validate_aprovacion1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_aprovacion1_cb

  // ---------- Validate observacion
  function do_ajax_autorizaciones_mob_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_observacion(var_observacion, var_script_case_init, do_ajax_autorizaciones_mob_validate_observacion_cb);
  } // do_ajax_autorizaciones_mob_validate_observacion

  function do_ajax_autorizaciones_mob_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_observacion_cb

  // ---------- Validate status
  function do_ajax_autorizaciones_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldCheckbox(nomeCampo_status, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_status(var_status, var_script_case_init, do_ajax_autorizaciones_mob_validate_status_cb);
  } // do_ajax_autorizaciones_mob_validate_status

  function do_ajax_autorizaciones_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_status_cb

  // ---------- Validate historial
  function do_ajax_autorizaciones_mob_validate_historial()
  {
    var nomeCampo_historial = "historial";
    var var_historial = scAjaxGetFieldText(nomeCampo_historial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizaciones_mob_validate_historial(var_historial, var_script_case_init, do_ajax_autorizaciones_mob_validate_historial_cb);
  } // do_ajax_autorizaciones_mob_validate_historial

  function do_ajax_autorizaciones_mob_validate_historial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizaciones_mob_validate_historial_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_autorizaciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_autorizaciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_autorizaciones_mob_submit_form(var_clave, var_persona, var_fecha, var_tipo, var_valor, var_tiempo, var_aprovacion1, var_observacion, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_autorizaciones_mob_submit_form_cb);
  } // do_ajax_autorizaciones_mob_submit_form

  function do_ajax_autorizaciones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_autorizaciones_mob_submit_form_cb_after_alert);
  } // do_ajax_autorizaciones_mob_submit_form_cb
  function do_ajax_autorizaciones_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_autorizaciones_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_public_historial"] = "off";

  function do_ajax_autorizaciones_mob_navigate_form()
  {
    perform_ajax_autorizaciones_mob_navigate_form();
  }

  function perform_ajax_autorizaciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_autorizaciones_mob_navigate_form(var_clave, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_autorizaciones_mob_navigate_form_cb);
  } // do_ajax_autorizaciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['autorizaciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_autorizaciones_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_autorizaciones_mob_navigate_form_cb_after_alert);
  } // do_ajax_autorizaciones_mob_navigate_form_cb
  function do_ajax_autorizaciones_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_autorizaciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_autorizaciones_mob_navigate_form_cb_after_alert
  function sc_hide_autorizaciones_mob_form()
  {
