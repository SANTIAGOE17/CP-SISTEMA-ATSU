<?php
@session_start() ;
$_SESSION['scriptcase']['Reporte_metricas2']['sc_process_barr'] = true;
require_once('../Reporte_metricas2/index.php');
unset($_SESSION['scriptcase']['Reporte_metricas2']['sc_process_barr']);
$ExportCtrl = new Reporte_metricas2_export_control;
$ExportCtrl->Export_barr();

class Reporte_metricas2_export_control
{
