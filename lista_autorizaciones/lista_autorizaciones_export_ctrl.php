<?php
@session_start() ;
$_SESSION['scriptcase']['lista_autorizaciones']['sc_process_barr'] = true;
require_once('../lista_autorizaciones/index.php');
unset($_SESSION['scriptcase']['lista_autorizaciones']['sc_process_barr']);
$ExportCtrl = new lista_autorizaciones_export_control;
$ExportCtrl->Export_barr();

class lista_autorizaciones_export_control
{
