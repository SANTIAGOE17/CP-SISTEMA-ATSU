...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_lista_autorizaciones').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_lista_autorizaciones').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_lista_autorizaciones').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_lista_autorizaciones').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_lista_autorizaciones').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_lista_autorizaciones').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_lista_autorizaciones').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_lista_autorizaciones').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_lista_autorizaciones').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_lista_autorizaciones').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_lista_autorizaciones').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_lista_autorizaciones').style.width  = '0px';
        if (oResp["setValue"]) {
