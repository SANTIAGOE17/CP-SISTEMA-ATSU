...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["coprogreso_____lista_autorizaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["coprogreso_____lista_autorizaciones"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['autorizaciones'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>lista_autorizaciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['embutida_filho'] as $ind => $sc_init)
          {
