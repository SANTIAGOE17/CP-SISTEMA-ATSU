...
*/
    ...
    $SC_apl_proc = "lista_autorizaciones";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['lista_autorizaciones']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['lista_autorizaciones']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['lista_autorizaciones']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['lista_autorizaciones']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['lista_autorizaciones']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
