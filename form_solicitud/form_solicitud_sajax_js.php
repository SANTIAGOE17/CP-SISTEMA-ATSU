  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_solicitud" == sTestField)
        {
...
?>
  ...
  // ---------- Validate clave
  function do_ajax_form_solicitud_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldHidden(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_clave(var_clave, var_script_case_init, do_ajax_form_solicitud_validate_clave_cb);
  } // do_ajax_form_solicitud_validate_clave

  function do_ajax_form_solicitud_validate_clave_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_clave_cb

  // ---------- Validate persona
  function do_ajax_form_solicitud_validate_persona()
  {
    var nomeCampo_persona = "persona";
    var var_persona = scAjaxGetFieldHidden(nomeCampo_persona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_persona(var_persona, var_script_case_init, do_ajax_form_solicitud_validate_persona_cb);
  } // do_ajax_form_solicitud_validate_persona

  function do_ajax_form_solicitud_validate_persona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "persona";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_persona_cb

  // ---------- Validate valor
  function do_ajax_form_solicitud_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_valor(var_valor, var_script_case_init, do_ajax_form_solicitud_validate_valor_cb);
  } // do_ajax_form_solicitud_validate_valor

  function do_ajax_form_solicitud_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_valor_cb

  // ---------- Validate tipo
  function do_ajax_form_solicitud_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_solicitud_validate_tipo_cb);
  } // do_ajax_form_solicitud_validate_tipo

  function do_ajax_form_solicitud_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_tipo_cb

  // ---------- Validate tiempo
  function do_ajax_form_solicitud_validate_tiempo()
  {
    var nomeCampo_tiempo = "tiempo";
    var var_tiempo = scAjaxGetFieldRadio(nomeCampo_tiempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_tiempo(var_tiempo, var_script_case_init, do_ajax_form_solicitud_validate_tiempo_cb);
  } // do_ajax_form_solicitud_validate_tiempo

  function do_ajax_form_solicitud_validate_tiempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiempo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_tiempo_cb

  // ---------- Validate cuotas
  function do_ajax_form_solicitud_validate_cuotas()
  {
    var nomeCampo_cuotas = "cuotas";
    var var_cuotas = scAjaxGetFieldHidden(nomeCampo_cuotas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_cuotas(var_cuotas, var_script_case_init, do_ajax_form_solicitud_validate_cuotas_cb);
  } // do_ajax_form_solicitud_validate_cuotas

  function do_ajax_form_solicitud_validate_cuotas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cuotas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_cuotas_cb

  // ---------- Validate status
  function do_ajax_form_solicitud_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldCheckbox(nomeCampo_status, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_status(var_status, var_script_case_init, do_ajax_form_solicitud_validate_status_cb);
  } // do_ajax_form_solicitud_validate_status

  function do_ajax_form_solicitud_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_status_cb

  // ---------- Validate observacion
  function do_ajax_form_solicitud_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_solicitud_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_solicitud_validate_observacion_cb);
  } // do_ajax_form_solicitud_validate_observacion

  function do_ajax_form_solicitud_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_solicitud_validate_observacion_cb

  // ---------- Event onchange tiempo
  function do_ajax_form_solicitud_event_tiempo_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_solicitud_event_tiempo_onchange(var_cuotas, var_valor, var_tiempo, var_script_case_init, do_ajax_form_solicitud_event_tiempo_onchange_cb);
  } // do_ajax_form_solicitud_event_tiempo_onchange

  function do_ajax_form_solicitud_event_tiempo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tiempo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_solicitud_event_tiempo_onchange_cb_after_alert);
  } // do_ajax_form_solicitud_event_tiempo_onchange_cb
  function do_ajax_form_solicitud_event_tiempo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_solicitud_event_tiempo_onchange_cb_after_alert

  // ---------- Event onclick tiempo
  function do_ajax_form_solicitud_event_tiempo_onclick()
  {
    var var_cuotas = scAjaxGetFieldHidden("cuotas");
    var var_valor = scAjaxGetFieldText("valor");
    var var_tiempo = scAjaxGetFieldRadio("tiempo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_solicitud_event_tiempo_onclick(var_cuotas, var_valor, var_tiempo, var_script_case_init, do_ajax_form_solicitud_event_tiempo_onclick_cb);
  } // do_ajax_form_solicitud_event_tiempo_onclick

  function do_ajax_form_solicitud_event_tiempo_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tiempo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_solicitud_event_tiempo_onclick_cb_after_alert);
  } // do_ajax_form_solicitud_event_tiempo_onclick_cb
  function do_ajax_form_solicitud_event_tiempo_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_solicitud_event_tiempo_onclick_cb_after_alert

  // ---------- Event onchange valor
  function do_ajax_form_solicitud_event_valor_onchange()
  {
    var var_cuotas = scAjaxGetFieldHidden("cuotas");
    var var_valor = scAjaxGetFieldText("valor");
    var var_tiempo = scAjaxGetFieldRadio("tiempo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_solicitud_event_valor_onchange(var_cuotas, var_valor, var_tiempo, var_script_case_init, do_ajax_form_solicitud_event_valor_onchange_cb);
  } // do_ajax_form_solicitud_event_valor_onchange

  function do_ajax_form_solicitud_event_valor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "valor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_solicitud_event_valor_onchange_cb_after_alert);
  } // do_ajax_form_solicitud_event_valor_onchange_cb
  function do_ajax_form_solicitud_event_valor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_solicitud_event_valor_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_solicitud_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_solicitud_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_solicitud_submit_form(var_clave, var_persona, var_valor, var_tipo, var_tiempo, var_cuotas, var_status, var_observacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_solicitud_submit_form_cb);
  } // do_ajax_form_solicitud_submit_form

  function do_ajax_form_solicitud_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_solicitud_submit_form_cb_after_alert);
  } // do_ajax_form_solicitud_submit_form_cb
  function do_ajax_form_solicitud_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_solicitud_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_solicitud_navigate_form()
  {
    perform_ajax_form_solicitud_navigate_form();
  }

  function perform_ajax_form_solicitud_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_solicitud_navigate_form(var_clave, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_solicitud_navigate_form_cb);
  } // do_ajax_form_solicitud_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_solicitud']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_solicitud_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_solicitud_navigate_form_cb_after_alert);
  } // do_ajax_form_solicitud_navigate_form_cb
  function do_ajax_form_solicitud_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_solicitud_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_solicitud_navigate_form_cb_after_alert
  function sc_hide_form_solicitud_form()
  {
